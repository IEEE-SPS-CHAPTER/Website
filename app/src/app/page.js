...
export default function Home() {
  ...
  const blogPosts = [
    ...
    { id: 4, title: "THE POTENTIAL OF 5G MILLIMETER WAVE TECHNOLOGY", readTime: "3 min read", author: "Akshita", date: "Jul 21, 2024", content: "5G mmWave is a high-frequency band in 5G offering ultra-fast data speeds, low latency, and massive capacity. Ideal for urban areas, AR/VR, and IoT, it enables next-gen connectivity. This article explores its features, benefits, challenges, and applications across industries like healthcare, automation, and emergency response systems.", category: "Security", link: "https://medium.com/@vitieeesps/the-potential-of-5g-millimeter-wave-technology-35d5e0874440" },
              ...
              <div className="relative h-[500px] flex items-center justify-center">
                {blogPosts.map((post, index) => (
                  ...
                  >
                    ...
                    <div className="text-lg leading-relaxed text-gray-700 text-justify">{post.content}</div>
                    ...
                    <button onClick={nextCard} className="group absolute right-8 bottom-8 w-15 h-15 bg-gradient-to-r from-gray-400 to-gray-300 rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110 hover:shadow-2xl shadow-lg z-40" aria-label="Next blog post">
                      <ArrowIcon />
                    </button>
                  </div>
                ))}
